...
import { TicketType } from './TicketTypeSelector';
      ...
      <View style={styles.formFields}>
        ...
        <TouchableOpacity
          style={[
            ...
            (!hasSelectedTickets() || !buyerInfo.name || !buyerInfo.email || !buyerInfo.cpf || processing) && styles.purchaseButtonDisabled
          ]}
          onPress={onPurchase}
          disabled={processing || !hasSelectedTickets() || !buyerInfo.name || !buyerInfo.email || !buyerInfo.cpf}
        >
          <Text style={styles.purchaseButtonText}>
            Finalizar Compra - R$ {formatPrice(getTotalPrice())}
          </Text>
        </TouchableOpacity>
